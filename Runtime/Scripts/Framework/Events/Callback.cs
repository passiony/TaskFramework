...
public delegate TF.Runtime.ECommandReply CommandHandle(params object[] args);
public delegate TF.Runtime.ECommandReply CommandHandler<T>(T command, bool undo) where T : TF.Runtime.ICommand;
